    ...
    return (
        <form onSubmit={handleSubmitSendMessageForm}>
            <div className="footer-content">
                <div className="footer-content-plus-icon">
                    <span>
                ...
                <div className="footer-content-emoji-icon">
                    <span>
                ...
                <input type="text" placeholder='Escribe un mensaje...' id='message' name='message' required className="footer-content-input"/>
                <button type='submit' className="footer-content-send">
                    <span className="send">
