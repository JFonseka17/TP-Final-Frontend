...
const ContactHeader = ({ contact }) => {
    return (
        <div className="contact-header">
            ...
            <div className="asdfh2">
                <span className="asdfh11">{contact.name}</span>
            </div>
            <div className="ContactHeaderButtons">
                <button className="ContactHeaderButton">
                    <span>
